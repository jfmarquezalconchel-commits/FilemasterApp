...
public class FileSystem {
    ...
    public List<com.filemasterapp.FilemasterApp.Model.FileSystem> fileSystemtoFoundCache;
    ...
    private com.filemasterapp.FilemasterApp.Model.FileSystem getFromCurrentFilesystems(com.filemasterapp.FilemasterApp.Model.FileSystem toFind) {
        com.filemasterapp.FilemasterApp.Model.FileSystem fileSystemFound=null;
        ...
        for(com.filemasterapp.FilemasterApp.Model.FileSystem fileSystem:this.fileSystemtoFoundCache) {
    ...
    public List<com.filemasterapp.FilemasterApp.Model.FileSystem> getFileSystemList() {
    ...
    public void FileSystemLoader() {
        ...
        for (FileSystemMapper fs : lista) {
            ...
            com.filemasterapp.FilemasterApp.Model.FileSystem main = new com.filemasterapp.FilemasterApp.Model.FileSystem(input);
            ...
            com.filemasterapp.FilemasterApp.Model.FileSystem alreadyFs=getFromCurrentFilesystems(main);
            if(alreadyFs!=null) {
            ...
            for (FileSystemMapper fs2 : fs.children) {
                ...
                if (Arrays.asList(validFs).contains(fs2.fstype)) {
                    ...
                    com.filemasterapp.FilemasterApp.Model.FileSystem child =new com.filemasterapp.FilemasterApp.Model.FileSystem(input2);
                    ...
                    com.filemasterapp.FilemasterApp.Model.FileSystem alreadyFsChild=getFromCurrentFilesystems(child);
    ...
    public void scanFileSystem(com.filemasterapp.FilemasterApp.Model.FileSystem fs) throws IOException {
