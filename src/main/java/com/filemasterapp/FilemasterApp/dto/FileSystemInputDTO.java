...
/**
 * DTO (Data Transfer Object) para representar un sistema de archivos en entrada.
 * <p>
 * Contiene la información necesaria para crear o actualizar un sistema de archivos,
 * incluyendo destino, origen, tipo de sistema de archivos, opciones y capacidad.
 * </p>
 */
public class FileSystemInputDTO {
     ...
     */
    public FileSystemInputDTO(String target, String source, String fstype, String options, Long capacity, Long available, Long inuse, FileSystem parent) {
        this.fstype = fstype;
        this.target = target;
        this.source = source;
     ...
     * Formato: target|source|fstype|options|enabled|capacity|available|inuse|lastUpdate|uuid|partuuid|partlabel
     *
     * @return cadena con la información del sistema de archivos
     */
    @Override
    public String toString() {
        return this.target + "|" + this.source + "|" + this.fstype + "|" + this.options + "|" + this.enabled + "|" + this.capacity + "|" + this.available + "|" + this.inuse + "|" + this.lastUpdate + "|" + this.uuid + "|" + this.partuuid + "|" + this.partlabel;
    }
}